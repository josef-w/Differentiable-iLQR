...
def main():
    ...
    parser.add_argument('--mode', type=str, default='sysid',
                        choices=['nn', 'empc', 'imempc','sysid'])
    ...
    if args.mode == 'empc' or args.mode == 'imempc':
...
class IL_Exp:
    def __init__(self, **kwargs):
        ...
        elif self.mode in ['empc', 'imempc','sysid']:
    ...
    def run(self):
        ...
        if self.mode == 'nn':
            opt = optim.Adam(
                ...
                1e-4)
        elif self.mode == 'empc' or self.mode == 'imempc':
            params1 = []
        ...
        if self.mode in ['empc', 'imempc','sysid']:
